...
//! ensuring compatibility with the version used by `ratatui-crossterm`. By using
...
//! `ratatui-crossterm`, then any code using `crate::backend::crossterm::crossterm` will refer to
