...
use crate::layout::{Alignment, Constraint, Flex, Layout, Position, Rect};
...
impl<'a> Axis<'a> {
	...
	/// # Example
	///
	/// [`Axis`] also implements [`Stylize`](crate::style::Stylize) which mean you can style
	/// it like so
	///
	/// ```rust
	/// use crate::style::Stylize;
...
/// use crate::widgets::{Dataset, GraphType};
///
...
impl<'a> Dataset<'a> {
	...
	/// # Example
	///
	/// [`Dataset`] also implements [`Stylize`](crate::style::Stylize) which mean you can
	/// style it like so
	///
	/// ```rust
	/// use crate::style::Stylize;
	/// use crate::widgets::Dataset;
	///
...
/// use crate::style::{Style, Stylize};
/// use crate::symbols;
/// use crate::widgets::{Axis, Block, Chart, Dataset, GraphType};
///
...
impl<'a> Chart<'a> {
	...
	///
	/// ```
	/// use crate::widgets::{Chart, LegendPosition};
	///
