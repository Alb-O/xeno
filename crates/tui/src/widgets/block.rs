...
///
/// `Block` implements [`Stylize`](crate::style::Stylize), allowing you to use style
/// shorthand methods:
///
/// ```
...
///
/// ```
/// use crate::style::{Color, Style, Stylize};
...
/// # See Also
///
/// - [Block recipe] - Visual examples and common patterns (on the tome_tui website)
/// - [Collapse borders recipe] - Techniques for creating seamless layouts (on the tome_tui website)
/// - [`MergeStrategy`] - Controls how borders merge with adjacent elements
///
/// [`Paragraph`]: crate::widgets::paragraph::Paragraph
...
impl<'a> Block<'a> {
	...
	/// slices (`&str`), borrowed strings (`Cow<str>`), [spans](crate::text::Span), or
	/// vectors of [spans](crate::text::Span) (`Vec<Span>`).
	///
	...
	///
	/// ```
	/// use crate::{ widgets::Block, text::Line };
	///
	/// Block::bordered()
	...
	///
	/// ```
	/// use crate::{widgets::Block, symbols};
	///
