...
use crate::symbols::braille::BRAILLE;
use crate::symbols::pixel::{OCTANTS, QUADRANTS, SEXTANTS};
use crate::symbols::{self, Marker};
use crate::text::Line as TextLine;
...
impl Painter<'_, '_> {
	...
	/// ```
	/// use crate::symbols;
	/// use crate::widgets::canvas::{Context, Painter};
	///
