...
/// use crate::widgets::{Block, Row, Table};
///
...
impl<'a> Table<'a> {
	...
	/// ```rust
	/// use crate::layout::Constraint;
	/// use crate::widgets::{Block, Cell, Row, Table};
	///
	/// let rows = [Row::new(vec!["Cell1", "Cell2"])];
	/// let widths = [Constraint::Length(5), Constraint::Length(5)];
	...
	///
	/// ```rust
	/// # use crate::{layout::Constraint, style::{Style, Stylize}, widgets::{Row, Table}};
	/// # let rows = [Row::new(vec!["Cell1", "Cell2"])];
	/// # let widths = [Constraint::Length(5), Constraint::Length(5)];
	...
	/// ```rust
	/// use crate::layout::Constraint;
	/// use crate::widgets::{HighlightSpacing, Row, Table};
	///
	/// let rows = [Row::new(vec!["Cell1", "Cell2"])];
	/// let widths = [Constraint::Length(5), Constraint::Length(5)];
	...
	/// to the last column.
	/// ```
	/// use crate::layout::{Constraint, Flex};
	/// use crate::widgets::{Row, Table};
	///
	/// let widths = [
	///     Constraint::Min(10),
