...
/// use crate::widgets::{Bar, BarChart, BarGroup, Block};
///
/// BarChart::default()
...
impl<'a> BarChart<'a> {
	...
	///
	/// ```rust
	/// use crate::widgets::{Bar, BarChart, BarGroup};
	///
	...
	///
	/// For [`Horizontal`](crate::layout::Direction::Horizontal) bars this becomes the height
	/// of the bar.
	///
