//! `tome-tui` provides easy-to-use macros for simplifying boilerplate
...
//! # Getting Started
//!
//! Add `tome-tui` as a dependency in your `Cargo.toml`:
//!
//! ```shell
//! cargo add tome-tui
//! ```
...
//! # Contributing
//!
//! Contributions to `tome-tui` are welcome! Whether it's submitting a bug report, a feature
...
//!
//!
//! [Crates.io badge]: https://img.shields.io/crates/v/tome-tui?logo=rust&style=flat-square
//! [License badge]: https://img.shields.io/crates/l/tome-tui
//! [CI Badge]:
//! [Docs.rs badge]: https://img.shields.io/docsrs/tome-tui?logo=rust&style=flat-square
//! [Crate Downloads badge]:
//!     https://img.shields.io/crates/d/tome-tui?logo=rust&style=flat-square
//! [API Docs]: https://docs.rs/tome-tui
