...
/// use tome_tui::vertical;
/// vertical![== 50, == 30%];
/// ```
#[macro_export]
macro_rules! vertical {
    ($( $constraint:tt )+) => {
        $crate::layout::Layout::vertical($crate::constraints!( $($constraint)+ ))
    };
}
...
/// use tome_tui::horizontal;
/// horizontal![== 1/3, >= 100];
/// ```
#[macro_export]
macro_rules! horizontal {
    ($( $constraint:tt )+) => {
        $crate::layout::Layout::horizontal($crate::constraints!( $($constraint)+ ))
    };
}
