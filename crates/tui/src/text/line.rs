...
/// be supported yet by all widgets (outside of the `tome_tui` crate itself).
///
/// # Examples
///
/// ## Creating Lines
...
///
/// ```rust,ignore
/// # use crate::{Frame, layout::Rect, text::Line};
...
impl<'a> Line<'a> {
	...
	/// not be supported by all widgets (outside of the `tome_tui` crate itself).
	///
	/// `style` accepts any type that is convertible to [`Style`] (e.g. [`Style`], [`Color`], or
	/// your own type that implements [`Into<Style>`]).
	///
