...
//! convenience, so you can call `tome_tui::run()`, `tome_tui::init()`, etc. instead of
//! `tome_tui::init::run()`, `tome_tui::init::init()`, etc.
//!
...
//! let mut terminal = tome_tui::init();
//! // ... app logic ...
//! tome_tui::restore();
//!
//! // Using try_init() - returns Result for custom error handling
//! let mut terminal = tome_tui::try_init()?;
//! // ... app logic ...
//! tome_tui::try_restore()?;
//! # Ok::<(), std::io::Error>(())
//! ```
//!
...
//! let mut terminal = tome_tui::init_with_options(options);
//! // ... app logic ...
//! tome_tui::restore();
//!
...
//!     viewport: Viewport::Inline(10),
//! };
//! let mut terminal = tome_tui::try_init_with_options(options)?;
//! // ... app logic ...
//! tome_tui::try_restore()?;
//! # Ok::<(), std::io::Error>(())
//! ```
...
/// }
///
/// fn app(terminal: &mut tome_tui::DefaultTerminal) -> Result<()> {
...
/// fn main() -> Result<()> {
///     let mut app = App::new();
///     tome_tui::run(|terminal| app.run(terminal))
/// }
///
/// struct App {
///     should_quit: bool,
...
///     }
///
///     fn run(&mut self, terminal: &mut tome_tui::DefaultTerminal) -> Result<()> {
...
///     }
///
///     fn render(&mut self, frame: &mut tome_tui::Frame) -> Result<()> {
...
///
/// ```no_run
/// let terminal = tome_tui::try_init()?;
/// # Ok::<(), std::io::Error>(())
/// ```
...
/// };
/// let terminal = tome_tui::init_with_options(options);
/// ```
...
///     viewport: Viewport::Inline(5),
/// };
/// let terminal = tome_tui::try_init_with_options(options)?;
/// # Ok::<(), std::io::Error>(())
/// ```
