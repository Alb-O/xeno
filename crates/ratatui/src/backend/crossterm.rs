...
//! re-exported as `crate::backend::crossterm::crossterm`. This re-export is essential for authors of widget
...
//! `crate::backend::crossterm::crossterm` for such operations, developers can avoid version conflicts and
...
//! `ratatui-crossterm`, then any code using `crate::backend::crossterm::crossterm` will refer to the 0.29
