...
use crate::registry::notifications::animation::{
	FadeHandler, expand_calculate_rect, fade_calculate_rect, slide_apply_border_effect,
	slide_calculate_rect,
};
use crate::registry::notifications::notification::{Notification, calculate_size};
use crate::registry::notifications::types::{
...
impl crate::registry::notifications::stacking::StackableNotification for NotificationState {
	fn id(&self) -> u64 {
		self.id
	}
...
impl crate::registry::notifications::render::RenderableNotification for NotificationState {
...
mod tests {
	use super::*;
	use crate::registry::notifications::types::{AutoDismiss, Timing};
