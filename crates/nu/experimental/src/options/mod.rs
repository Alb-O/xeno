#![allow(private_interfaces, reason = "The marker structs don't need to be exposed, only the static values.")]
...
pub static ALL: &[&ExperimentalOption] = &[&EXAMPLE, &REORDER_CELL_PATHS, &PIPE_FAIL, &ENFORCE_RUNTIME_ANNOTATIONS];
