...
pub fn parse_iter<'i, Ctx: Clone>(iter: impl Iterator<Item = (Cow<'i, str>, Option<Cow<'i, str>>, Ctx)>) -> Vec<(ParseWarning, Ctx)> {
...
impl ParseWarning {
	...
	pub fn help(&self) -> Option<String> {
		match self {
			...
			Self::DeprecatedDefault(_) => Some(String::from("You can safely remove this option now.")),
		}
	}
}
