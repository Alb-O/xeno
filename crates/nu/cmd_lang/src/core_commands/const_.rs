...
impl Command for Const {
	...
	fn signature(&self) -> xeno_nu_protocol::Signature {
		Signature::build("const")
			...
			.required("const_name", SyntaxShape::VarWithOptType, "The constant name to create.")
			.required(
				"initial_value",
  ...
  https://www.nushell.sh/book/thinking_in_nu.html"#
	...
	fn run_const(&self, _working_set: &StateWorkingSet, _call: &Call, _input: PipelineData) -> Result<PipelineData, ShellError> {
