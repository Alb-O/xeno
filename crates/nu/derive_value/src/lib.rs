...
//! The tests for functionality can be found in `xeno_nu_protocol::value::test_derive`.
//!
//! This documentation is often less reference-heavy than typical Rust documentation.
//! This is because this crate is a dependency for `xeno_nu_protocol`, and linking to it would create a
//! cyclic dependency.
