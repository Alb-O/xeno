...
use xeno_nu_protocol::ast::CellPath;
use xeno_nu_protocol::{PipelineData, ShellError, Signals, Span, Value};
...
pub fn operate<C, A>(cmd: C, mut arg: A, input: PipelineData, span: Span, signals: &Signals) -> Result<PipelineData, ShellError>
where
