...
use crate::{ShellError, Span, Spanned, Type, Value};
...
pub trait CustomValue: fmt::Debug + Send + Sync {
	...
	///   ╰── self [self_span]
	/// ```
	fn follow_path_int(&self, self_span: Span, index: usize, path_span: Span, optional: bool) -> Result<Value, ShellError> {
	...
	///   ╰── self [self_span]
	/// ```
	fn follow_path_string(&self, self_span: Span, column_name: String, path_span: Span, optional: bool, casing: Casing) -> Result<Value, ShellError> {
