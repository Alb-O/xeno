...
use crate::{PipelineData, ShellError, Signature};
...
impl Command for Alias {
	...
	fn run(&self, _engine_state: &EngineState, _stack: &mut Stack, call: &Call, _input: PipelineData) -> Result<PipelineData, ShellError> {
