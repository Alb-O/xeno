...
use crate::registry::notifications::stacking::{StackableNotification, calculate_stacking_positions};
use crate::registry::notifications::types::{Anchor, AnimationPhase, Level};
use crate::registry::notifications::ui::{
...
pub trait RenderableNotification: StackableNotification {
	...
	fn animation_type(&self) -> crate::registry::notifications::types::Animation;
...
fn apply_fade_if_needed<T: RenderableNotification>(
	...
	use crate::registry::notifications::types::Animation;
