...
use crate::registry::actions::{ActionResult, ObjectSelectionKind, PendingAction, PendingKind};
use crate::registry::{TextObjectDef, find_text_object_by_trigger};
use crate::range::Range;

fn select_object_with_trigger(
	ctx: &crate::registry::actions::ActionContext,
